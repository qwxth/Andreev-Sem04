...
export class ProductPage {
    constructor(parent, id, modelPath) {
        ...
        console.log("ProductPage created:", { id, modelPath });
    }
    getHTML() {
        return `
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-6">
                        <div id="car-3d-container" style="width:100%; height:400px; border-radius:20px; overflow:hidden; position:relative; background:#f8f9fa;"></div>
                    </div>
                    <div class="col-md-6">
    ...
    getData() {
        ...
        return map[this.id] || { title: "Продукт", fullText: "Описание", price: "цена" };
    }
    clickBack() { 
    ...
    render() {
        console.log("ProductPage render start");
        ...
        if (infoDiv) {
            ...
            if (orderBtn) orderBtn.addEventListener('click', () => alert('Демо. Оформление на официальном сайте.'));
        }
        const container = document.getElementById('car-3d-container');
        if (container) {
            console.log("Создаём Car3DComponent с modelPath:", this.modelPath);
            const car3d = new Car3DComponent(container, this.modelPath);
            car3d.render();
        } else {
            console.error("Контейнер car-3d-container не найден");
        }
    }
}
